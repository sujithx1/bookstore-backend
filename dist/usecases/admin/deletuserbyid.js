...
exports.ToogleuserActiveuseCase = void 0;
const AppError_1 = require("../../config/AppError");
const types_1 = require("../../types/types");
class ToogleuserActiveuseCase {
    constructor(userrep) {
    ...
    execute(userid, isActive) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            console.log(active);
            const update = yield this.userrep.findIdBlockToogle(userid, active);
            if (!update)
...
exports.ToogleuserActiveuseCase = ToogleuserActiveuseCase;
