...
exports.AddressdeleteuseCase = void 0;
...
class AddressdeleteuseCase {
    ...
    execute(userId, addressId) {
        return __awaiter(this, void 0, void 0, function* () {
            const deleteAddress = yield this.userrep.deleteaddressbyid(userId, addressId);
            if (!deleteAddress)
...
exports.AddressdeleteuseCase = AddressdeleteuseCase;
